        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    if (id != null) {
                    %>
                    <li class="nav-item"><a class="nav-link" href="${pageContext.servletContext.contextPath}/readlater/page">Read Later</a>
                    </li>
                         ...
                         <div class="col-md-4">
                             ...
                             <div class="card-body">
                               ...
                               <div class="d-flex justify-content-between align-items-center">
                                 ...
                                 <div>
                                   	<br> <a
                                    href="${pageContext.servletContext.contextPath}//likedbook/delete?bookid=${book.id}">
